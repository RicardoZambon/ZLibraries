...
export abstract class RouteHelper {
  public static getRouteByData(
    ...
    return routeSnapshot.data[key] === value
      ? routeSnapshot
      : this.getRouteByData(routeSnapshot.firstChild, key, value);
  }
  ...
  public static getRouteWithComponent(
    ...
    return routeSnapshot.component === component
      ? routeSnapshot
      : this.getRouteWithComponent(routeSnapshot.firstChild, component);
  }

  public static getRouteURL(route: ActivatedRouteSnapshot, rootLevel = false): string {
    let segments: string[] = [];
