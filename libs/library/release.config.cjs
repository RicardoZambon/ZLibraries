  ...
  plugins.push(
    [
      '@semantic-release/exec',
      {
        ...
        prepareCmd: 'node ../../scripts/stamp-changelog.mjs library ${nextRelease.version} --dist',
      },
    ],
    [
...
module.exports = {
  // 1.6.x is the maintenance line for applications still on Angular 19: main moved to Angular 22,
  ...
  branches: isValidation
    ...
    : ['main', { name: '1.6.x', range: '1.6.x', channel: '1.6.x' }],
